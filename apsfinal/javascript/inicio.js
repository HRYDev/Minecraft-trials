...
document.getElementById("overword1").style = "display:none";
document.getElementById("nether2").style = "display:block";
document.getElementById("Theend3").style = "display:none";
